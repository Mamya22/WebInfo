...
def start_tkinter():
    ...
    tk.Radiobutton(root, text="Movie", variable=tk.StringVar(value="movie"), value="movie",font=("Arival",30)).pack()
    tk.Radiobutton(root, text="Book", variable=tk.StringVar(value="book"), value="book",font=("Arival",30)).pack()
