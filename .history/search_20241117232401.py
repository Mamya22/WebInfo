...
def start_tkinter():
    ...
    tk.Radiobutton(root, text="Movie", variable=mode_var, value="book",font=("Arival",30)).pack()
    tk.Radiobutton(root, text="Book", variable=mode_var, value="movie",font=("Arival",30)).pack()
