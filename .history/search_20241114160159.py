...
class BooleanMatch:
    def __init__(self):
        ...
        self.book_reverted_dict_path = "./result/book_revert_dict.json"
        self.movie_reverted_dict_path = "./result/movie_revert_dict.json"
    ...
    def print_message(self,_id: int):
        if(self.mode == 'book'):
            ...
            print("Success! The book you want is here!")
            print(Fore.GREEN,"ID:   ",_id)
            print("Tag: ")
