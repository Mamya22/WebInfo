...
class StatusWindow:
    def __init__(self):
        ...
        # 状态文本框
        self.label = tk.Label(self.root, text="Status", font=("Arial", 20))
        self.status_text = tk.Text(self.root, height=10, width=100)
        self.status_text.pack(pady=10)

        # 结果文本框
        self.label = tk.Label(self.root, text="Result", font=("Arial", 20))
...
class BooleanMatch:
    ...
    def print_message(self,_id: int):
        ...
        if(self.mode == 'book'):
            ...
            status_window.update_status("Success! The book you want is here!")
            status_window.update_status("ID:   "+str_id)
            status_window.update_status("Tag: ")
            status_window.update_status(show_tag)
            ...
            status_window.update_status("Success! The movie you want is here!")
            status_window.update_status("ID:   "+str_id)
            status_window.update_status("Tag: ")
            status_window.update_status(show_tag)
