...
def start_tkinter():
    ...
    mode_var = tk.StringVar(value="movie")
    tk.Label(root, text="Select mode:", font=("Arial", 30)).pack()
    tk.Radiobutton(root, text="Book", variable=mode_var, value="book", font=("Arial", 30)).pack()
    tk.Radiobutton(root, text="Movie", variable=mode_var, value="movie", font=("Arial", 30)).pack()
