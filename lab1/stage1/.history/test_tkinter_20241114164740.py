...
def start_tkinter():
    ...
    tk.Label(root, text="Select mode:",font=("Arival",14)).pack()
    tk.Radiobutton(root, text="Book", variable=mode_var, value="book",font=("Arival",14)).pack()
    tk.Radiobutton(root, text="Movie", variable=mode_var, value="movie",font=("Arival",14)).pack()
