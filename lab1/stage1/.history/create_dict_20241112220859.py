...
if __name__ == "__main__":
    ...
    # 输出倒排表，倒排表路径
    with open(r"C:\Users\28932\OneDrive\桌面\Web\lab\lab1\WebInfo\result\movie_reverted_dict.json","w",encoding="UTF-8") as fout_reverted_dict:
       json.dump(skip2.reverted_dict,fout_reverted_dict, indent=4, ensure_ascii=False)
    # 输出跳表，跳表路径
    with open(r"C:\Users\28932\OneDrive\桌面\Web\lab\lab1\WebInfo\result\movie_skip_dict.json","w",encoding="UTF-8") as fout_skip_dict:
