...
class BooleanMatch:
    def __init__(self):
        ...
        self.book_info_path = './result/book_keyword.json'
        self.movie_info_path = './result/movie_keyword.json'
        self.book_reverted_dict_compress_path = './result/book_compressed_revert_dict.bin'
        # self.book_vocabulary = '../Dataset/Book_vocabulary.txt'
        self.movie_reverted_dict_compress_path = './result/movie_compressed_revert_dict.bin'
        ...
        self.book_reverted_dict = self.decompress(self.book_reverted_dict_compress_path)
        self.movie_reverted_dict = self.decompress(self.movie_reverted_dict_compress_path)
