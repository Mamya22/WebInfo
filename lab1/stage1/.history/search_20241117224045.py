...
class BooleanMatch:
        ...
        if not L1_id_list or not L2_id_list:
            ...
            while index1 < len_1 and index2 < len_2:
                ...
                while index1 % interval_1 == 0 and index1 < len_1 - interval_1:
                    if (index1 // interval_1 < len(L1_skip_list) and
                        index1 // interval_1 >= 0 and
                        ...
                        index1 += interval_1
                        index2 += 1
                    elif (index1 // interval_1 < len(L1_skip_list) and
                        index1 // interval_1 >= 0 and
                        L1_id_list[index1] < L2_id_list[index2] and
                        L1_id_list[L1_skip_list[index1 // interval_1][1]] < L2_id_list[index2]):
                ...
                while index2 % interval_2 == 0 and index2 < len_2 - interval_2:
                    if (index2 // interval_2 < len(L2_skip_list) and
                        index2 // interval_2 >= 0 and
                        ...
                        index2 += interval_2
                        index1 += 1
                    elif (index2 // interval_2 < len(L2_skip_list) and
                        index2 // interval_2 >= 0 and
                        L2_id_list[index2] < L1_id_list[index1] and
                        L2_id_list[L2_skip_list[index2 // interval_2][1]] < L1_id_list[index1]):
                ...
                if index1 < len_1 and index2 < len_2:
                    val1 = L1_id_list[index1]
                    val2 = L2_id_list[index2]
        ...
        if not self.error:
            ...
            while index1 < len_1 and index2 < len_2:
                ...
                while index1 % interval_1 == 0 and index1 < len_1 - interval_1:
                    if (index1 // interval_1 < len(L1_skip_list) and
                        L1_id_list[index1] < L2_id_list[index2] and
                        L1_skip_list[index1 // interval_1][1] < len_1 and
                        L1_id_list[L1_skip_list[index1 // interval_1][1]] < L2_id_list[index2]):
                ...
                while index2 % interval_2 == 0 and index2 < len_2 - interval_2:
                    if (index2 // interval_2 < len(L2_skip_list) and
                        L2_id_list[index2] < L1_id_list[index1] and
                        L2_skip_list[index2 // interval_2][1] < len_2 and
                        L2_id_list[L2_skip_list[index2 // interval_2][1]] < L1_id_list[index1]):
    ...
    def AND_NOT(self, T1: Tuple, T2: Tuple) -> Tuple:
        ...
        if not L1_id_list or not L2_id_list:
            status_window.update_status("The operand 'AND_NOT' lacks parameter!")
            self.error = True
    ...
    def NOT(self, T: Tuple) -> Tuple:
        return self.AND_NOT(self.pre_sort_list, T)
