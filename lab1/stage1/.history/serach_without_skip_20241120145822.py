...
class BooleanMatch:
    ...
    def OR(self, T1: Tuple, T2: Tuple) -> Tuple:
        ...
        end_time = time.time()
        print(f"OR operation took {(end_time - start_time) * 1e6} us")
    ...
    def AND(self, T1: Tuple, T2: Tuple) -> Tuple:
        ...
        print(f"AND operation took {(and_end_time - and_start_time) * 1e6} us")
        return ret, self.CreateInvertedIndex(ret)
    ...
    def AND_NOT(self, T1: Tuple, T2: Tuple) -> Tuple:
        ...
        print(f"AND NOT operation took {(and_not_end_time - and_not_start_time) * 1e6} us")
        return ret, self.CreateInvertedIndex(ret)
